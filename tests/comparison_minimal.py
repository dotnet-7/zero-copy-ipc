...
try:
    ...
    def main():
        ...
        iterations = 300  # 中等规模测试
    name = f"test_{os.getpid()}"
    d1 = ZeroCopyDict.create(name, max_items=600, heap_size=5*1024*1024)  # 2x容量
    ...
    update_ops = iterations / update_time
    ...
    write_ops_m = iterations / write_time_m
    ...
    read_ops_m = iterations / read_time_m
    ...
    update_ops_m = iterations / update_time_m
